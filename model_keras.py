...
path=r'C:\Users\Anu\Documents\Work\datasets\fruits-360' #Thats my Training and Validation Data Path

train_dir=os.path.join(path,'training')
validation_dir=os.path.join(path,'validation')
testing_path=os.path.join(path,'test-multiple_fruits')
...
test_datagen=test_generator.flow_from_directory(testing_path)
